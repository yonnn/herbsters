...
public:
    CMainParams() {
		...
		{  11111, uint256S("0xc7d6ca1bbdf519c7a7cdc3a065b62ffe42a624942d86b91f5606ba316dacf4d7")},
                {  21111, uint256S("0xac5632441620df7d9c56e4fb7df1f76d9e6369765808e10d4ee46ed939dcde9e")},
                {  21638, uint256S("0x50c266b38e30a91d06312c9beda2ed7d6ff831667749550e4f6ddd9349bc9e43")},
                {  69357, uint256S("0x133026339c827f85c92a7dceedccc7d3b21df5d506419cd0a0383b8af56364ab")},
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1593157878, 589741, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x900fa1740a1618b77af1b177bd5d3942cb0b1d4a4cf4c4baade85a458c0d2940"));
        assert(genesis.hashMerkleRoot == uint256S("0x770471d0a88e7055530eff99505dc13cc7ea5ddd469571b6a4bc9db1818156da"));
        ...
        checkpointData = (CCheckpointData) {
            {
                {0, uint256S("0x900fa1740a1618b77af1b177bd5d3942cb0b1d4a4cf4c4baade85a458c0d2940")},
            }
        };
...
public:
    CRegTestParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x31f1f8bd57be90cfcdd9689709672ec19ff560bd4fd99b4e05fff448a49aaf17"));
        assert(genesis.hashMerkleRoot == uint256S("0x5074919390b7735957f19e2502fbedfb4d7d1786ba0332eee0b50376e0c74751"));
        ...
        checkpointData = (CCheckpointData) {
            {
                {0, uint256S("0x31f1f8bd57be90cfcdd9689709672ec19ff560bd4fd99b4e05fff448a49aaf17")},
            }
        };
